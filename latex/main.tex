...
\begin{frame}{Data collection}
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Data quality: outliers due to liquidity drainage and exchange specific issues.
    \end{itemize} 
...
\begin{frame}{Epilogue \& possible extensions}
  \begin{itemize}
    ...
    \item Day trading/short-term (hours/days) holdoing period but can possibly shed light on long-term asset allocation.
  \end{itemize}
  \begin{figure}[htbp] % h=here, t=top, b=bottom, p=page
    \centering
